# FREYJA
**Important note:** FREYJA was originally built using Java. The initial Java implementation can be found under the *java_code* branch. Nonetheless, we highly recommend using the current, Python-based implementation (*main* branch), as it is less prone to errors and considerably faster.
